...
#np.savetxt('MainPts.txt',MainPts[index_final[:,0],:], fmt='%.6e', delimiter=' ', newline='\n')
#np.savetxt('couronne.txt', Pts[index2[:,0],:][index_main[:,0],:], fmt='%.6e', delimiter=' ', newline='\n')
np.save('gouttes.npy',MainPts[~index_final[:,0],:])
np.save('MainPts.npy',MainPts[index_final[:,0],:])
