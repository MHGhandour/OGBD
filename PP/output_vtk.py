...
#%%
for sim in [16000,16400,16700,17700,19800,20700,21500,21600,21700,22300,22600,22800,23200,23500,23600,23800,23900,24400,25100,25500,25700]:
    ...
    del MainPts,Gi_splash
    npy2vtk_V_P(Original,'/media/mhg/DATA/VTK/couronne-P-'+str(sim)+'.vtk')
#    
